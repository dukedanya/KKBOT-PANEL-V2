...
def onboarding_text() -> str:
    return (
        ...
        "Внутри подписки уже есть <b>Основной сервер</b> и резервные <b>Белые списки</b>, "
        "поэтому после импорта обычно ничего настраивать отдельно не нужно."
    )
...
def onboarding_platform_text(*, platform: str, subscription_url: str = "") -> str:
    ...
    lines = [
        ...
        "В подписке уже есть <b>Основной сервер</b> и резервные <b>Белые списки</b>.",
    ]
    if plain_happ_url:
        lines.extend(
            [
                ...
                "4. После импорта сначала попробуйте <b>Основной сервер</b>. Если он временно недоступен, используйте любой <b>Белый список</b>.",
                "",
